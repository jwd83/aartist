...
- See [[architecture]] for rendering and state details.

## Recently Shipped
- **Grid selection** — Left-click drag to select rectangular regions (see [[features]]).
- **Internal copy/paste** — Structured buffer with `clipBuffer` (see [[clipboard]]).
